...
exports.SiteModule = SiteModule = __decorate([
    (0, common_1.Module)({
        controllers: [site_controller_1.SiteController, public_site_controller_1.PublicSiteController],
        providers: [site_service_1.SiteService, prisma_service_1.PrismaService],
    })
], SiteModule);
